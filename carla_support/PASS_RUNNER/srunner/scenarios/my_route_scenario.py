...
class RouteScenario(BasicScenario):
    ...
    def _update_route(self, world, config, debug_mode):
        ...
        gps_route, route = interpolate_trajectory(config.trajectory)  # 5.0 meters is the _base_vehicle_threshold
    ...
    def _update_ego_vehicle(self):
        ...
        ego_vehicle = CarlaDataProvider.request_new_actor('vehicle.tesla.cybertruck',
                                                          elevate_transform,
                                                          rolename='hero')
    ...
    def _build_scenario_instances(self, world, ego_vehicle, scenario_definitions,
        ...
        for scenario_number, definition in enumerate(scenario_definitions):
            ...
            scenario_configuration.ego_vehicles = [ActorConfigurationData('vehicle.tesla.cybertruck',
