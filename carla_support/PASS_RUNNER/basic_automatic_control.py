...
class World(object):
    ...
    def restart(self, args):
        ...
        # Spawn the player and teleport it to the start point.
        if self.player is None:
            print("Waiting for the ego vehicle...")
            time.sleep(1)
            possible_vehicles = self.world.get_actors().filter('vehicle.tesla.*')
...
def game_loop(args):
    ...
    try:
        ...
        for config in scenario_configurations:
            ...
            destination = carla.Location(start_location.x+30, start_location.y, start_location.z)
            ...
            while True:
                ...
                if agent.done():
                    if args.loop:
                        ...
                        agent.set_destination(destination)
                        world.hud.notification("The target has been reached, restart", seconds=4.0)
