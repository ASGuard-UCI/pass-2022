...
class ResultOutputProvider(object):
    ...
    def create_output_text(self):
        ...
        # Create the title
        output = "\n"
        output += "\033[1m========= Results of the game  ------ {} \033[1m=========\033[0m\n".format(self._global_result)
        output += "\n"
        ...
        for (_idx, _scenario) in enumerate(self._data.scenarios):
            for criterion in _scenario.get_criteria():
                ...
                #     name = "RouteCompletionScore-ego{}".format(_idx+1)
                ...
                if name == "CollisionTest":
                    ...
                    for collision_event in criterion.list_traffic_events:
                        ...
                        if collision_type == TrafficEventType.COLLISION_STATIC:
                            ...
                            collision_score += 0
                    name = "CollisionScore-ego{}".format(_idx+1)
        ...
        total_score = '\033[92m' + str(
            collision_score + traffic_light_score + stopsign_score) + '\033[0m'
        list_statistics.extend([[name, total_score]])
