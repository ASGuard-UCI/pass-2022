...
from leaderboard.utils.autosec_result_writer import ResultOutputProvider
...
class ScenarioManager(object):
            ...
            for criterion in self.scenario.get_criteria():
                ...
                if _name == "CollisionTest":
                    for collision_event in criterion.list_traffic_events:
                        ...
                        if collision_type == TrafficEventType.COLLISION_PEDESTRIAN:
                            _checkpoint_num += 1
    ...
    def _tick_scenario(self, timestamp):
        ...
        if self._timestamp_last_run < timestamp.elapsed_seconds and self._running:
            ...
            # control lincoln only
            # for ego_to_control in self.ego_vehicles:
            #     if 'lincoln' in ego_to_control.model:
            #         ego_to_control.apply_control(ego_action)
