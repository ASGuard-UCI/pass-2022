...
import carla
from leaderboard.autoagents.detour_agents.carla_basic_agent import BasicAgent
...
class DetourAgent(AutonomousAgent):
    ...
    def run_step(self, input_data, timestamp):
        ...
        if not self._agent:
            ...
            self._agent = BasicAgent(hero_actor, target_speed=50)
