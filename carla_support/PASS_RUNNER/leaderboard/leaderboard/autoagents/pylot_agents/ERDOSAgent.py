...
from leaderboard.autoagents.pylot_agents.ERDOSBaseAgent import ERDOSBaseAgent, \
    process_visualization_events, read_control_command
from srunner.utilities import msg_logging
...
class ERDOSAgent(ERDOSBaseAgent):
    ...
    def setup(self, path_to_conf_file):
        ...
        # record some massages
        msg_logging.log_msg(self._pose_stream)
        # msg_logging.log_msg(self._control_stream)
        msg_logging.log_msg(self._perfect_traffic_lights_stream)
