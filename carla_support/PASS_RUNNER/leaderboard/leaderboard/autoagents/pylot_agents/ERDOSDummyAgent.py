...
def get_entry_point():
    return 'ERDOSDummyAgent'


class ERDOSDummyAgent(ERDOSBaseAgent):
    ...
    def setup(self, path_to_conf_file):
        super(ERDOSDummyAgent, self).setup(path_to_conf_file)
    ...
    def destroy(self):
        ...
        self.logger.info('ERDOSDummyAgent destroy method invoked')
        # Stop the ERDOS node.
