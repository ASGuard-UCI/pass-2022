...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        print("\n\033[1m========= Preparing {} (repetition {}) =========".format(config.name, 0))
        ...
        try:
            ...
            self.prepare_ego_vehicles_and_walkers(config.ego_vehicles, config.walkers, False)
            ...
            if args.record:
                self.client.start_recorder("{}/{}_rep{}.log".format(args.record, config.name, 0))
