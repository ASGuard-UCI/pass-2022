...
from achilles.autoagents import autonomous_agent
from achilles.autoagents.team_lbc.team_code.planner import RoutePlanner
...
class BaseAgent(autonomous_agent.AutonomousAgent):
    ...
    def tick(self, input_data):
        ...
        gps = np.array([input_data['ego_state'].position.x, input_data['ego_state'].position.z])
        speed = input_data['ego_state'].speed
        compass = np.radians(input_data['ego_state'].rotation.y)
