...
from achilles.autoagents.team_lbc.carla_project.src.image_model import ImageModel
from achilles.autoagents.team_lbc.carla_project.src.converter import Converter

from achilles.autoagents.team_lbc.team_code.base_agent import BaseAgent
from achilles.autoagents.team_lbc.team_code.pid_controller import PIDController
...
class ImageAgent(BaseAgent):
    def setup(self, path_to_conf_file):
        ...
        self.net = ImageModel.load_from_checkpoint(conf.get('model'))
        self.net.cuda()
        self.net.eval()
    ...
    def run_step(self, input_data, timestamp):
        ...
        desired_speed = np.linalg.norm(points_world[0] - points_world[1]) * 6.0
